...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Check if a file passed as argument is"
                                                 " binary or not")

    parser.add_argument("filename", help="File name to check for. If the file is not in the "
                                         "same folder, include full path")
